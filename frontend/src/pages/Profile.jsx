      ...
      {loading ? (
        <div className="flex items-center justify-center min-h-screen">
          <div className="relative">
            <div className="animate-spin rounded-full h-16 w-16 border-t-3 border-b-3 border-teal-600"></div>
            <div className="absolute inset-0 animate-ping rounded-full h-16 w-16 border-2 border-cyan-600 opacity-20"></div>
          </div>
        </div>
      ) : (
          ...
          `}>
            ...
            <div className="hidden lg:block p-6 border-b bg-gradient-to-r from-gray-50 to-gray-100">
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 rounded-full bg-gradient-to-br from-teal-600 to-cyan-600 flex items-center justify-center text-white text-2xl font-bold shadow-lg ring-4 ring-teal-100">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                        <div>
                          ...
                          <input 
                            ...
                            className="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm bg-gray-50 focus:outline-none focus:ring-2 focus:ring-teal-600 transition-all"
                            readOnly
                          />
                        </div>
                        <div>
              ...
              {activeSection === 'orders' && (
                <div className="bg-white rounded-2xl shadow-sm p-6 sm:p-10">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <button onClick={refreshOrders} className="px-3 py-1.5 bg-gradient-to-r from-teal-600 to-cyan-600 hover:from-teal-700 hover:to-cyan-700 text-white rounded-lg text-sm font-medium shadow-md hover:shadow-lg transition-all">Refresh</button>
                  </div>
                  {loadingOrders ? (
                              ...
                              <div key={idx} className="flex items-center gap-3">
                                ...
                                <div className="flex-1">
                                  ...
                                  <div className="text-xs text-gray-600">
                                    Qty: {it.quantity}
                                    {it.size && <span className="ml-2 text-teal-600 font-semibold">| Size: {it.size}</span>}
                                  </div>
                                </div>
                    ...
                    <div className="text-center py-8 sm:py-16">
                      ...
                      <button onClick={() => navigate('/shop')} className="px-6 sm:px-8 py-3 bg-gradient-to-r from-teal-600 to-cyan-600 text-white rounded-xl font-medium hover:shadow-lg transition-all duration-300 transform hover:scale-105">
                        Start Shopping
                      </button>
                    </div>
                  )}
                    ...
                    <div className="p-4 sm:p-6">
                      ...
                      <div className="text-center py-8 sm:py-16">
                        ...
                        <button 
                          ...
                          className="px-6 sm:px-8 py-3 bg-gradient-to-r from-teal-600 to-cyan-600 text-white rounded-xl font-medium hover:shadow-lg transition-all duration-300 transform hover:scale-105"
                        >
                          Add New Address
                        </button>
                      </div>
